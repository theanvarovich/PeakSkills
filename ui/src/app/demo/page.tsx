        ...
        <div className="max-w-4xl w-full text-center space-y-12 z-10">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-foreground leading-tight">
              Experience the Power of <br/> <WordmarkLogo /> Matching
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Test our AI-driven matching engine in real-time. No registration required. Provide your CV or a Vacancy description to see instant, deterministic results against our live database.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-stretch mt-10">
            ...
            <Link href="/demo/candidate" className="group flex flex-col space-y-6 p-10 border border-border rounded-xl bg-card w-full max-w-md text-left shadow-sm hover:shadow-md transition-all hover:border-primary/50 cursor-pointer">
              ...
              <div>
                <h3 className="font-semibold text-2xl text-foreground mb-2 group-hover:text-primary transition-colors">Candidate Demo</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Paste your CV or LinkedIn summary. Our AI will analyze your profile and instantly match you against the open vacancies in our system to show you your personalized ranking.
                </p>
              </div>
            </Link>
            ...
            <Link href="/demo/employer" className="group flex flex-col space-y-6 p-10 border border-border rounded-xl bg-card w-full max-w-md text-left shadow-sm hover:shadow-md transition-all hover:border-primary/50 cursor-pointer">
              ...
              <div>
                <h3 className="font-semibold text-2xl text-foreground mb-2 group-hover:text-primary transition-colors">Employer Demo</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Paste a job description. Our AI will extract the core requirements and instantly scan our talent pool to rank the most qualified candidates based on hard, deterministic metrics.
                </p>
              </div>
            </Link>
          </div>
